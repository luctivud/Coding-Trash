...
// Title: kickstart-a.cpp
// dated: 12-07-2020 10:34:12
...
#define                  _INP47T(V3CT07_)   for(auto &V3CT07____IT7T : V3CT07_) _SC4N(V3CT07____IT7T)
...
void solveEach(lld TestCaseNumber = 1) {
    ...
    FOR4NGE(i, 0, n, 1) {
        ...
        } else if (arr[i] > maxSoFar and arr[i] > arr[i+1]) {
            ans += 1;
        }
