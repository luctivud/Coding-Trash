...
// void dfs(lld node, lld parent, lld depth, vector<lld> adj[], vector<lld> values, lld &xorsum) {
// 	EACH(i, adj[node]) {
// 		if (i != parent) {
// 			if (values[i]) {
// 				xorsum ^= depth;
// 			}
// 			dfs(i, node, depth + 1, adj, values, xorsum);
// 		}
// 	}
// }
